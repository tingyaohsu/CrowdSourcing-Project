...
out_file = open('TurkerResult.csv', 'w')
write_file = csv.writer(out_file)
write_file.writerow(['workerid','text_of_story'])
...
for assignment in assignments:
    ...
    row = worker_id+','+only_answer+'\n'
    write_file.writerow([worker_id,only_answer])
    #writer.write(['workerid','text_of_story'])
